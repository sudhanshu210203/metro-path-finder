...
main_window.configure(background="#F0E68C")

topside = LabelFrame(main_window, bd=2, bg="#1E90FF")
topside.pack(side=TOP, fill=X, pady=10, padx=5)

img = PhotoImage(file=r"logo.png")
photo_label=Label(topside, image=img, bg="white")
photo_label.pack(side=LEFT)

img2 = PhotoImage(file=r"logo.png")
photo_label2=Label(topside, image=img2, bg="white")
photo_label2.pack(side=RIGHT)

text_label=Label(topside, text="DELHI METRO ROUTE", font=("Helvetica", 30, "bold"), fg="white", bg="#1E90FF")
text_label.pack(side=LEFT, padx=30)

leftside = LabelFrame(main_window, bd=0, bg="#F0E68C")
leftside.place(x=100, y=200, height=200, width=300)

start=Label(leftside, text="SOURCE", font=("Helvetica", 18, "bold"), fg="black", bg="#F0E68C")
start.pack(side=TOP, padx=10, pady=30)
dest=Label(leftside, text="DESTINATION", font=("Helvetica", 18, "bold"), fg="black", bg="#F0E68C")
dest.pack(side=TOP, padx=10, pady=27)

centerside = LabelFrame(main_window, bd=0, bg="#F0E68C")
centerside.place(x=380, y=200, height=200, width=300)
value1 = StringVar()
combo1 = ttk.Combobox(centerside, width=25, font=("Helvetica", 16), height=10, textvariable=value1, state='readonly', justify='center')
...
value2 = StringVar()
combo2 = ttk.Combobox(centerside, width=25, font=("Helvetica", 16), height=10, textvariable=value2, state='readonly', justify='center')
...
def print_route(arr_sta, dis):
    rightside = LabelFrame(main_window, bg="#F0E68C", bd=0)
    ...
    listbox = Listbox(rightside, bd=2, bg="#1E90FF", fg="white", font=("Helvetica", 14, "bold"), yscrollcommand=scrollbar.set, xscrollcommand=scrollbar2.set)
...
click_button = Button(main_window, text="Find Route", width=20, font=("Helvetica", 14, "bold"), bg="#1E90FF", fg="white", command=click_me)
click_button.place(x=300, y=425)

link_button = Button(main_window, text="Click Here To View Map", width=20, font=("Helvetica", 14, "bold"), bg="#1E90FF", fg="white", command=openlink)
link_button.place(x=300, y=475)

exit_button = Button(main_window, text="Exit", width=20, font=("Helvetica", 14, "bold"), bg="#1E90FF", fg="white", command=exit_window)
